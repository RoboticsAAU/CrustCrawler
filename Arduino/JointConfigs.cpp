...
Joint Joint2 = { 2, 0.220, -1200, 1200, 885, MX106R };
Joint Joint3 = { 3, 0.147, -1500, 1500, 885, MX64R };
Joint Joint4 = { 4, 0.115, -1800, -1024, 885, MX28R }; //maxTheta is 0.75*4095, minTheta is 10 from MID on blackboard (where grippers touch)
Joint Joint5 = { 5, 0.115, 1024, 1800, 885, MX28R }; //minTheta is 0.25*4095, maxTheta is 10 from MID on blackboard (where grippers touch)
